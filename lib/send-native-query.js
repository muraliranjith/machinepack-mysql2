...
module.exports = {
  ...
  description: 'Send a native query to the mysql2 database.',
  ...
  exits: {
    ...
    success: {
      ...
      moreInfoUrl: 'https://github.com/felixge/node-mysql2#getting-the-id-of-an-inserted-row',
      outputExample: '==='
      // outputExample: {
      //   result: '===',
      //   meta: '==='
  ...
  fn: function sendNativeQuery(inputs, exits) {
    ...
    // Send native query to the database using node-mysql2.
    inputs.connection.query(queryInfo, function query() {
      // The exact format of the arguments for this callback are not part of
      // the officially documented behavior of node-mysql2 (at least not as
      ...
      //  • https://github.com/felixge/node-mysql2#performing-queries
      //  • https://github.com/felixge/node-mysql2/blob/f5bd13d8c54ce524a6bff48bfceb15fdca3a938a/lib/protocol/ResultSet.js
      //  • https://github.com/felixge/node-mysql2/blob/d4a5fd7b5e92a1e09bf3c85d24265eada8a84ad8/lib/protocol/sequences/Sequence.js#L96
      //  • https://github.com/felixge/node-mysql2/blob/1720920f7afc660d37430c35c7128b20f77735e3/lib/protocol/sequences/Query.js#L94
      //  • https://github.com/felixge/node-mysql2/blob/1720920f7afc660d37430c35c7128b20f77735e3/lib/protocol/sequences/Query.js#L144
      //
      ...
      if (arguments[1]) {
        ...
        if (_.isArray(arguments[1])) {
          ...
          return exits.error(new Error('Query was successful, but output from node-mysql2 is in an unrecognized format.  Output:\n' + util.inspect(Array.prototype.slice.call(arguments), { depth: null })));
        }
      }
