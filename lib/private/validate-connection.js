module.exports = require('machine').build({
  ...
  description: 'Check if this looks like a valid mysql2 connection instance.',
  ...
  exits: {
    ...
    success: {
      outputFriendlyName: 'Is probably mysql2 connection',
      outputDescription: 'If the provided appears to be a valid mysql2 connection instance.',
      outputExample: true
    },
