...
module.exports = {
  ...
  fn: function parseNativeQueryError(inputs, exits) {
    ...
    if (err.code === 'ER_DUP_ENTRY') {
      ...
      // the mysql2 error message and extracting the relevant bits.
      // (See also: https://github.com/balderdashy/sails-mysql2/blob/2c414f1191c3595df2cea8e40259811eb3ca05f9/lib/adapter.js#L1223)
