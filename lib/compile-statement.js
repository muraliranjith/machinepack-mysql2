...
module.exports = {
  ...
  description: 'Compile a Waterline statement to a native query for mysql2.',
  ...
  exits: {
    ...
    notSupported: {
      description: 'The provided Waterline statement could not be compiled because it is not supported by this mysql2 driver.',
      extendedDescription: 'If even one clause of the Waterline statement is not supported by the mysql2 driver, the compilation of the entire statement _always fails_.',
      outputVariableName: 'report',
